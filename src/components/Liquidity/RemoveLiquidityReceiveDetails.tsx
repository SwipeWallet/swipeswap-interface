...
import { Currency, currencyEquals, WETH } from '@swipewallet/swipeswap-sdk'
                    ...
                    <AutoColumn>
                        ...
                        <RowBetween className="text-sm">
                            {hasWETH ? (
                                <StyledInternalLink
                                    to={`/remove/${
                                        currencyA === Currency.ETHER ? WETH[chainId].address : currencyId(currencyA)
                                    }/${currencyB === Currency.ETHER ? WETH[chainId].address : currencyId(currencyB)}`}
                                >
