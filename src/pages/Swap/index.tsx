...
import { ChainId, CurrencyAmount, JSBI, Token, Trade } from '@swipewallet/swipeswap-sdk'
...
export default function Swap() {
    ...
    return (
        <>
            <Helmet>
                <title>{i18n._(t`Swap`)} | Swipe</title>
                <meta
                    name="description"
                    content="Swipe allows for swapping of ERC20 compatible tokens across multiple networks"
                />
            </Helmet>
            <TokenWarningModal
